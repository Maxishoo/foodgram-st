    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=150, validators=[django.core.validators.RegexValidator(message='Введите корректное имя', regex='^[а-яА-ЯёЁa-zA-Z -]+$'), users.models.check_username], verbose_name='Имя')),
                ('last_name', models.CharField(max_length=150, validators=[django.core.validators.RegexValidator(message='Введите корректное имя', regex='^[а-яА-ЯёЁa-zA-Z -]+$'), users.models.check_username], verbose_name='Фамилия')),
